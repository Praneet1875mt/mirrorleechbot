...
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME",praneetleechnnbo)
HEROKU_API_KEY = getenv("UPDATES_CHANNEL", "01a04b5b-91b5-4eda-8412-eb58c84fba73")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1101776571").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/fc9d87ffd1c6f828eb7fc.png")
START_PIC = getenv("START_PIC", "https://telegra.ph/file/a414e2cdfeaa7d4414b89.png")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Praneet1875/mirrorleechbot")
